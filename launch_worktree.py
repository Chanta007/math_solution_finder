...
USAGE = """\
Usage: launch_worktree.py <name> [--base <branch>] [-h|--help]
...
Examples:
  ...
  python launch_worktree.py auth-refactor
  python launch_worktree.py hotfix --base main     # force base branch
"""
...
def main(argv: list[str]) -> int:
    name, base_override = parse_args(argv)
    ...
    if os.name == "nt":
        return subprocess.run([cli_path], cwd=str(worktree_dir)).returncode
    os.execvp(cli_path, [cli_path])
